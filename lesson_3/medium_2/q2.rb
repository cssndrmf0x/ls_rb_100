...
# Let's look at object id's again from the perspective of a method
# call instead of a block.

# Here we haven't changed ANY of the code outside or inside of the 
# block/method. We simply took the contents of the block from the 
# previous practice problem and moved it to a method, to which we 
# are passing all of our outer variables.
