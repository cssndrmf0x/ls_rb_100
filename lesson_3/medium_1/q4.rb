...
# the two, other than what operator she chose to use to add an 
...
# first one modifies the caller - modifies buffer in place, while
# the second one does not modify in place
