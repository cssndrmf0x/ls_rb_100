...
# negative number, and asked Alan to change the loop. How can 
# you make this work without using begin/end/until? Note that 
...
# so we essentially just don't even enter the loop if it is not valid input

# Bonus 1
# What is the purpose of the number % divisor == 0 ?
# This is how we determine if something is a factor, and if it divides
...
# it returns the factors array, the list of all factors of the number