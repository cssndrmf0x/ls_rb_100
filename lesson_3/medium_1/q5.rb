...
# the method can't access the limit variable because it is out of scope
# he can change it to a constant, or define the limit in the method,
# or pass it into the function as an argument
